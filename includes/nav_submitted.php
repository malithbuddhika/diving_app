...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb mt-2 mb-2">
    <li class="breadcrumb-item <?php echo ($currentPage === 'doc1') ? 'active' : ''; ?>">
      <a href="/englishDocuments/doc1/doc1_view.php" <?php echo ($currentPage !== 'doc1') ? 'style="color: blue;"' : ''; ?>>Step 1</a>
    </li>
    <li class="breadcrumb-item <?php echo ($currentPage === 'doc2') ? 'active' : ''; ?>">
      <a href="/englishDocuments/doc2/doc2_view.php" <?php echo ($currentPage !== 'doc2') ? 'style="color: blue;"' : ''; ?>>Step 2</a>
    </li>
    <li class="breadcrumb-item <?php echo ($currentPage === 'doc3') ? 'active' : ''; ?>">
      <a href="/englishDocuments/doc3/doc3_view.php" <?php echo ($currentPage !== 'doc3') ? 'style="color: blue;"' : ''; ?>>Step 3</a>
    </li>
    <li class="breadcrumb-item <?php echo ($currentPage === 'doc4') ? 'active' : ''; ?>">
      <a href="/englishDocuments/doc4/doc4_view.php" <?php echo ($currentPage !== 'doc4') ? 'style="color: blue;"' : ''; ?>>Step 4</a>
    </li>
  </ol>
</nav>
...
<div class="row justify-content-end">
  ...
  <button class="btn btn-secondary" id="homeBtn" onclick="backtohome()">Home</button>
  </div>
</div>
