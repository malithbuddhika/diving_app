...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO doc2 (userID,participantname, participantSignature, participantDate, parentSignature, parentDate, resortName, instructorName, diverAccidentInsurance, policyNumber)
            VALUES ('$userID','$participantName', '$participantSignatureData', '$participantDate', '$parentSignatureData', '$parentDate', '$selectedResortName', '$selectedInstructorLabel', '$diverAccidentInsurance', '$policyNumber')";
