...
<body class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h6> <strong>Please read carefully and fill in all blanks before signing.</strong></h6>
            <br>
            <p>I, <label class="spaces"> participant's name </label> hereby affirm that I am aware that skin and scuba diving have inherent risks which may result in serious injury or death.</p>
            ...
            <p>I understand and agree that neither my instructor( s),<label class="spaces"> instructor(s) name </label>,
                the facility through which I receive my instruction, <label class="spaces"> store/resort </label>
            ...
            <p>
                I, <label class="spaces"> participant's name </label> , BY THIS INSTRUMENT AGREE TO EXEMPT AND RELEASE MY
                INSTRUCTORS,<label class="spaces"> instructor(s) name </label>,THE FACILITY THROUGH WHICH I
                RECEIVE MY INSTRUCTION,<label class="spaces"> STORE/RESORT</label>, AND
